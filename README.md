...
The LEHT is a highly accurate **analytical** approach. The method uses Fourier series expansions to construct the fluctuating local thermal fields as exact solutions to the governing differential equations. The main features of this formulation include:
